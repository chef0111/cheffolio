...
export function SiteHeaderNav({ children }: { children?: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          'bg-popover ring-foreground/10 dark:ring-foreground/20 fixed bottom-[calc(--spacing(3)+env(safe-area-inset-bottom,0px))] left-1/2 z-50 flex w-fit -translate-x-1/2 items-center rounded-xl py-1 pr-1 pl-2.5 shadow-md ring sm:hidden',
