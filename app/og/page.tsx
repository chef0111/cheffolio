  ...
  return (
    <div className="flex h-dvh w-full flex-col items-center justify-center">
      <div className="flex h-screen w-[80vw] flex-col justify-center border-x md:w-2xl lg:w-4xl">
        <PanelContent className="decor-all flex h-80 w-full flex-col items-center justify-center gap-4 self-center p-0 **:data-[slot=panel-plus]:size-8 md:h-120 md:gap-8 [&_[data-slot=panel-plus]_svg]:size-6">
