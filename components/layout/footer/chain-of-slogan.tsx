...
const chainItemVariants = cva('hover:text-foreground transition-colors', {
  variants: {
    variant: {
      default: ' border-border border-x first:border-l-2 last:border-r-2',
      secondary:
        'bg-secondary text-secondary-foreground rounded-md mr-1 last:mr-0 hover:bg-secondary/80',
      outline:
        'border border-border rounded-md mr-1 last:mr-0 bg-background hover:bg-muted text-muted-foreground dark:border-input dark:bg-input/30 dark:hover:bg-input/50',
