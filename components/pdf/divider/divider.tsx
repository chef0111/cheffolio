...
import type { PDFComponentProps } from '@/components/pdf/types';
import type { Style } from '@/lib/pdfcn/pdf-primitives';
import { StyleSheet, Text as PDFText, View } from '@/lib/pdfcn/pdf-primitives';
import { resolveColor } from '@/lib/pdfcn/resolve-color';
