...
import { CANVAS_WIDTH, paddleMaxX, paddleMinX } from './constants';
...
export function PlayControl({
  ...
  return (
    <MobileControls label="Start game" className={className}>
      <Button
        type="button"
        size="lg"
        disabled={disabled}
...
export function PaddleSlider({
  ...
  return (
    <MobileControls label="Paddle control" className={className}>
